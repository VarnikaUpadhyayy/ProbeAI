...
2. Questions must relate to specific curriculum days and the candidate's actual progress.
3. Follow-up questions MUST be dynamically generated from the candidate's previous answer — \
never use scripted or generic follow-ups.
4. For weak areas: test foundational understanding and ask them to explain concepts they struggled with.
5. For strong areas: ask deeper, scenario-based questions to validate mastery.
6. Keep replies concise (2-4 sentences for questions, include brief acknowledgment when appropriate).
7. Do not reveal you are following a script or mention internal scoring.
8. Minimum interview length: 8 questions across at least 4 different curriculum days.
9. Respond ONLY with valid JSON as instructed in each prompt — no extra commentary, no markdown \
fences unless explicitly part of the JSON string content."""
...
{{"reply": "<greeting + first question>", "curriculum_day": {first_day}, "is_follow_up": false}}"""
...
Briefly acknowledge their previous answer, then ask ONE new technical question.
Respond with JSON only:
{{"reply": "<acknowledgment + question>", "curriculum_day": {day}, "is_follow_up": false}}"""
...
Respond with JSON only:
{{"reply": "<brief acknowledgment + follow-up question>", "curriculum_day": {day}, "is_follow_up": true}}"""
